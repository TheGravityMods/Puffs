...
public class TerminalLineBox extends AbstractWidget implements Widget, GuiEventListener {
    ...
    public TerminalLineBox(Font pFont, int pX, int pY, int pWidth, int pHeight, Component pMessage) {
        this(pFont, pX, pY, pWidth, pHeight, (net.minecraft.client.gui.components.EditBox)null, pMessage);
    }

    public TerminalLineBox(Font pFont, int pX, int pY, int pWidth, int pHeight, @Nullable net.minecraft.client.gui.components.EditBox p_94111_, Component pMessage) {
